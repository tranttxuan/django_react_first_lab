(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('child_process'), require('os')) :
  typeof define === 'function' && define.amd ? define(['child_process', 'os'], factory) :
  (global.webpackHookPlugin = factory(global.child_process,global.os));
}(this, (function (child_process,os) { 'use strict';
  ...
  var WebpackHookPlugin = /** @class */ (function () {
      ...
      WebpackHookPlugin.prototype.handleScript = function (script) {
          if (os.platform() === 'win32' || this.options.safe) {
              this.spreadStdoutAndStdErr(child_process.exec(script, this.puts));
          }
          else {
...
//# sourceMappingURL=webpack-hook-plugin.umd.js.map
